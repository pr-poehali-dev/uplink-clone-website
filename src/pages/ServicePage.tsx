    ...
    script.text = JSON.stringify([
      {
        ...
        "provider": { "@type": "LocalBusiness", "name": "ИТК Аплинк-IT", "telephone": content?.settings?.phone_href?.replace("tel:", "") ?? "+78452397738", "address": { "@type": "PostalAddress", "addressLocality": "Саратов", "addressCountry": "RU" } },
