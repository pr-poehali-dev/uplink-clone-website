...
const DEFAULT_ORDER = ["description", "benefits", "steps", "faq", "cta", "other", "calculator"];
...
export default function ServicePageSections({
  ...
  const sectionMap: Record<string, JSX.Element | null> = {
    description: show("description") && service.full_description ? (
      <section key="description" className="py-12 relative">
    ...
    // calculator рендерится в ServicePage.tsx
    calculator: null,
  };
