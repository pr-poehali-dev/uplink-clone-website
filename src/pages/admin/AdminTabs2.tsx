...
function TeamSortableItem({
  ...
  return (
    <div ref={setNodeRef} style={style} className="flex items-center gap-1">
      ...
      <button
        onClick={onClick}
        className={`flex-1 text-left px-2 py-2 rounded-xl text-sm transition-all truncate ${isSelected ? "bg-cyan-500/20 text-cyan-400 border border-cyan-500/30" : "text-gray-400 hover:text-white hover:bg-white/5"}`}
      >
        {member.name}
      </button>
    </div>
