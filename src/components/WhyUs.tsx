...
const advantages = [
  {
    ...
    desc: "Принимаем заявки 24/7. Вызов системного администратора в Саратове: реагирование на критические инциденты от 30 минут, удалённое подключение за 15 минут.",
    accent: "from-cyan-400 to-blue-500",
  },
  {
    icon: "Users",
    title: "Опытная команда",
    desc: "Сертифицированные специалисты с опытом от 5 лет. Системные администраторы, сетевые инженеры: Windows Server, Linux, Mikrotik, Cisco.",
    accent: "from-green-400 to-cyan-400",
  },
  {
    icon: "DollarSign",
    title: "Экономия до 40%",
    desc: "IT-аутсорсинг дешевле штатного IT-отдела до 40%. Платите фиксированную сумму от 7 000 ₽/мес — без скрытых переплат и простоев.",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            ...
            IT-компания в Саратове с опытом 10+ лет. Вот что отличает нас от других.
          </p>
        </div>
