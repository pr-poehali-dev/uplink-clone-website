...
function ContactCard({
  ...
  return (
    <div
      ref={ref}
      className={`glass-card neon-border rounded-2xl p-7 text-center transition-[opacity,transform] duration-[800ms] hover:scale-105 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-16"}`}
