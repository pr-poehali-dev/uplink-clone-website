...
function ContactCard({
  ...
  return (
    <div
      ...
      data-elem-type="card"
      className={`glass-card hover-card neon-border neon-hover neon-scale-sm rounded-2xl p-7 text-center scroll-anim ${isVisible ? "visible" : ""}`}
    >
      <div
    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <div className="glass-card hover-card neon-border neon-hover rounded-3xl p-10 max-w-2xl mx-auto">
